...
`
const StyledQuestionH1 = styled(H1)`
  padding-left: 1em;
`
...
export default ({ children }) => (
  <>
    <ReviewContainer>
      <CenterH1 size="1.5em">Review Your Application</CenterH1>
      <div>
        <HeaderDiv>
          <JohnDiv>
            <StyledP>TELL US ABOUT YOURSELF</StyledP>
        ...
        <StyledBanner wide={true} blur>
          <LeftDiv>
            ...
            <StyledSkillsH1 size="1.5em">
              We are the lovesick girls 네 멋대로 내 사랑을 끝낼 순 없어 We are the lovesick girls
              이 아픔 없인 난 아무 의미가 없어 But we were born to be alone Yeah, we were born to be
